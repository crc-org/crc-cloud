...
func NewDeploymentAtTenantScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:resources:DeploymentAtTenantScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentAtTenantScope(ctx *pulumi.Context,
	...
	var resource DeploymentAtTenantScope
	err := ctx.ReadResource("azure-native:resources:DeploymentAtTenantScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
