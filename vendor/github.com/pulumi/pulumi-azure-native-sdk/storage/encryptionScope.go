...
func NewEncryptionScope(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:storage:EncryptionScope", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEncryptionScope(ctx *pulumi.Context,
	...
	var resource EncryptionScope
	err := ctx.ReadResource("azure-native:storage:EncryptionScope", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
