...
func (o LookupAzureCliScriptResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupAzureCliScriptResult] {
	return pulumix.Output[LookupAzureCliScriptResult]{
