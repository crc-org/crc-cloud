...
func (o LookupDeploymentAtTenantScopeResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDeploymentAtTenantScopeResult] {
	return pulumix.Output[LookupDeploymentAtTenantScopeResult]{
